...
<head>
    ...
    <link href="<?= base_url('Main-Template/') ?>css2?family=Nunito:wght@400;500;600;700;800&display=swap" rel="stylesheet">
    <link rel="stylesheet" type="text/css" media="screen" href="<?= base_url('Main-Template/') ?>assets/css/style.css">
</head>
...
<body x-data="main" class="relative overflow-x-hidden font-nunito text-sm font-normal antialiased" :class="[ $store.app.sidebar ? 'toggle-sidebar' : '', $store.app.theme === 'dark' || $store.app.isDarkMode ?  'dark' : '', $store.app.menu, $store.app.layout,$store.app.rtlClass]">
    ...
    <script src="<?= base_url('Main-Template/') ?>assets/js/alpine-collaspe.min.js"></script>
    <script src="<?= base_url('Main-Template/') ?>assets/js/alpine-persist.min.js"></script>
    <script defer="" src="<?= base_url('Main-Template/') ?>assets/js/alpine-ui.min.js"></script>
    <script defer="" src="<?= base_url('Main-Template/') ?>assets/js/alpine-focus.min.js"></script>
    <script defer="" src="<?= base_url('Main-Template/') ?>assets/js/alpine.min.js"></script>

    <script src="<?= base_url('Main-Template/') ?>assets/js/custom.js"></script>
